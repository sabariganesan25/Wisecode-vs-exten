...
export declare class DashboardPanel {
    ...
    static readonly viewType = "wisecodeDashboard";
    ...
    private _handleCheckCompliance;
    private _handleFixCompliance;
    private _handleCheckFullFileCompliance;
    private _handleFixFullFileCompliance;
    private _handleApplyFullFileFix;
